...
from my_db.select_db import (
    select_user_management,
    select_user_department,
    select_user_mini_department,
    select_user_admin_department,
    select_user_admin_mini_department,
    select_user_management_button,
)
...
def main(page: ft.Page):
    ...
    card_total_management = [
        ...
        for i in select_user_management()
    ]

    card_total_department = [
        card(
            otdel=i["department_name"],
            position=i["post_name"],
            name=i["name"],
            phone=i["phonenumber"],
            mail=i["email"],
        ...
        for i in select_user_department()
    ]

    card_total_mini_department = [
        card(
            otdel=i["mini_department_name"],
            position=i["post_name"],
            name=i["name"],
            phone=i["phonenumber"],
            mail=i["email"],
        ...
        for i in select_user_mini_department()
    ]
    ...
    card_total_admin_department = [
        ...
        for i in select_user_admin_department("Административный департамент")
    ]
    ...
    card_total_roads = [
        ...
        for i in select_user_admin_department("Академия Умные дороги")
    ]
    ...
    card_total_admin_mini_department_dogovor = [
        ...
        for i in select_user_admin_mini_department("Договорной отдел")
    ]
    ...
    card_total_admin_mini_department_obshi = [
        ...
        for i in select_user_admin_mini_department("Общий отдел")
    ]
    ...
    card_management_licenz_button = [
        ...
        for i in select_user_management_button("Лицензионный отдел")
    ]
    ...
    card_management_market_button = [
        ...
        for i in select_user_management_button("Управление маркетинга")
    ]
                            ...
                            ft.Column(
                                [
                                    ...
                                    ft.Row(
                                        [
                                            ft.FilledButton(
                                                text="Административный департамент",
                                                color="black",
                                                bgcolor="#e1f4c7",
                                                on_click=admin_deporparment,
                                            ),
                                            ft.FilledButton(
                                                "Академия Умные дороги",
                                                color="black",
                                                bgcolor="#e1f4c7",
                                                on_click=admin_roads,
                                            ),
                                        ],
                                    ...
                                    ft.Row(
                                        [
                                            ft.FilledButton(
                                                ...
                                                color="black",
                                                bgcolor="#e1f4c7",
                                                on_click=admin_dogovor,
                                            ),
                                            ft.FilledButton(
                                                "Общий отдел",
                                                color="black",
                                                bgcolor="#e1f4c7",
                                                on_click=admin_obshi,
                                            ),
                                        ],
                                    ),
                                    ft.Text(""),
                                    ft.Row(
                                        [
                                            ft.FilledButton(
                                                ...
                                                color="black",
                                                bgcolor="#e1f4c7",
                                                on_click=management_licenz_button,
                                            ),
                                            ft.FilledButton(
                                                "Управление маркетинга",
                                                color="black",
                                                bgcolor="#e1f4c7",
                                                on_click=management_marketing_button,
                                            ),
                                        ],
                                        alignment=ft.MainAxisAlignment.CENTER,
                                    ),
